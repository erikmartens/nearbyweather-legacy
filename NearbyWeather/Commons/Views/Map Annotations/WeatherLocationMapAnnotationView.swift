...
final class WeatherLocationMapAnnotationView: MKAnnotationView {
  ...
  private func drawAnnotationView() {
    ...
    circleLayer.fillColor = fillColor?.cgColor ?? Constants.Theme.Color.MarqueColors.bookmarkDay.cgColor
    ...
    speechBubbleLayer.fillColor = fillColor?.cgColor ?? Constants.Theme.Color.MarqueColors.bookmarkDay.cgColor
