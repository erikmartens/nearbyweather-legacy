...
final class SettingsTextEntryCell: UITableViewCell, BaseCell {
  ...
  private lazy var textEntryTextField = Factory.TextField.make(fromType: .counter(count: Constants.Values.ApiKey.kOpenWeatherMapApiKeyLength, cornerRadiusWeight: .medium))
