...
private extension SetPermissionsViewController2 {
  struct Definitions {
...
final class SetPermissionsViewController2: UIViewController, BaseViewController {
  ...
  fileprivate lazy var bubbleDescriptionLabel = Factory.Label.make(fromType: .description(text: R.string.localizable.configure_location_permissions_description()))
...
extension SetPermissionsViewController2 {
