...
extension UIColor {
  ...
  open class var nearbyWeatherStandard: UIColor {
    UIColor(red: 80/255, green: 180/255, blue: 250/255, alpha: 1.0)
  }
  
  open class var nearbyWeatherStandardDark: UIColor {
    UIColor(red: 80/255, green: 138/255, blue: 250/255, alpha: 1.0)
  }
  
  open class var nearbyWeatherNight: UIColor {
    UIColor(red: 50/255, green: 113/255, blue: 156/255, alpha: 1.0)
  }
}
