...
class WelcomeScreenViewController: UIViewController {
    ...
    func configure() {
        ...
        descriptionLabel.text! = NSLocalizedString("welcome_api_key_description", comment: "")
        ...
        saveButton.setTitle(NSLocalizedString("save", comment: "").uppercased(), for: .normal)
        ...
        getInstructionsButtons.setTitle(NSLocalizedString("get_api_key_description", comment: "").uppercased(), for: .normal)
